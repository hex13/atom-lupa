...
export class Lupa extends React.Component {
    constructor(props) {
        ...
        this.navigationActions = NavigationActions(props.dispatch, props.editorWrapper);
    }
    componentDidMount() {
        ...
        setInterval(() => {
            const pos = this.props.activePosition;
            ...
            if (pos) {
                ...
                const el = <StatusBar {...this.previewEvents}
                    entities={entities}/>;
        ...
        return <div style={{position: 'relative', width: this.state.w}}>
            ...
            <button
             style={{background: 'inherit',
                ...
                boxShadow: !this.props.indexed? '0 0 3px grey' : 'none',
                transition: '0.7s all',
                width: '60%',
                margin: '10px',
                border: 'none',
                overflow: 'hidden',
                lineHeight: 1,
                padding: !this.props.indexed? '8px 6px': 0,
                textTransform: 'none',
                textAlign: 'center',
                borderRadius: 10}}
              onClick={()=> {
             ...
             className="btn lupa-index-project">
