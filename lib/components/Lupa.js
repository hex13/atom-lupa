        ...
        setInterval(() => {
            ...
            if (pos) {
                ...
                const el = <StatusBar
                    ...
                    onMouseOver={
                        (entity) => {
                            dispatch(navigationActions.SetPreview(entity));
                        }
                    }
                    onClick={(entity, e)=> {
                        ...
                        dispatch(navigationActions.GoTo(entity, false, {select: e.altKey}));
                    }}
                    entities={entities}/>;
        ...
        return {
            onFocus(e) {
                ...
                if (el.classList.contains('lupa-entity')) {
                        dispatch(navigationActions.SetPreview(el));
            ...
            onClick(e) {
                const el = e.target.closest('.lupa-entity');
                if (el) {
                    dispatch(navigationActions.GoTo(el, false, {select: e.altKey}));
                }
            }
        }
    }
