        ...
        setInterval(() => {
            ...
            if (pos) {
                ...
                const el = <StatusBar
                    ...
                    onClick={(entity)=> {
                        dispatch(navigationActions.GoToEntity(entity));
                    }}
                    entities={entities}/>;
        ...
        return <div style={{position: 'relative', width: this.state.w}}>
            ...
            <button
             style={{background: '#b00',
                maxHeight: this.state.redButton < 2? '1000px': '0',
                boxShadow: this.state.redButton < 2 ? '0 0 3px yellow' : 'none',
                transition: '2s all',
                width: '60%',
                margin: '10px',
                border: 'none',
                overflow: 'hidden',
                lineHeight: 1,
                padding: this.state.redButton < 2? '12px 6px': 0,
                textTransform: 'none',
                textAlign: 'center',
             ...
             className="btn cta">
             {this.state.redButton? <span>Please do not press<br/> this button again.</span> : '⬡ 🚀'}
             </button>
            <Structure
