    ...
    return {
        SetPreview(el) {
            return dispatch => {
                ...
                console.log("LAST", last, last.pos)
                dispatch({
                    type: 'goTo',
                    entityElement: el,
                });
...
export class Lupa extends React.Component {
    ...
    handleStructureFocus(e) {
        ...
        if (el.classList.contains('lupa-entity')) {
                this.props.dispatch(previewActions.SetPreview(el));
    ...
    handleStructureMouseLeave(e) {
        this.props.dispatch(previewActions.RemovePreview(true));
    }
    // TODO https://jsfiddle.net/6s7tufL5/2/
    handleStructureMouseOut(e) {
        this.props.dispatch(previewActions.RemovePreview());
    }
